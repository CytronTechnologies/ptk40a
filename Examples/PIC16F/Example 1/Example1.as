...
z	equ	0
pclath	equ	10
# 31 "E:\Cytron SVN\PTK40A (PIC Training Kit)\Source Code\Examples\Example 1\Main E_1.c"
...
;; *************** function _main *****************
;; Defined at:
;;		line 57 in file "E:\Cytron SVN\PTK40A (PIC Training Kit)\Source Code\Examples\Example 1\Main E_1.c"
...
;;
psect	maintext
	file	"E:\Cytron SVN\PTK40A (PIC Training Kit)\Source Code\Examples\Example 1\Main E_1.c"
	line	57
...
l3351:	
;Main E_1.c: 59: PORTA = 0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(5)	;volatile
	line	60
;Main E_1.c: 60: PORTB = 0;
	clrf	(6)	;volatile
	line	61
;Main E_1.c: 61: PORTC = 0;
	clrf	(7)	;volatile
	line	62
;Main E_1.c: 62: PORTD = 0;
	clrf	(8)	;volatile
	line	63
;Main E_1.c: 63: PORTE = 0;
	clrf	(9)	;volatile
	line	69
	
l3353:	
;Main E_1.c: 69: TRISA = 0b00010001;
	movlw	(011h)
...
l3355:	
;Main E_1.c: 70: TRISB = 0b00001111;
	movlw	(0Fh)
	movwf	(134)^080h	;volatile
	line	71
	
l3357:	
;Main E_1.c: 71: TRISC = 0b10010011;
	movlw	(093h)
	movwf	(135)^080h	;volatile
	line	72
	
l3359:	
;Main E_1.c: 72: TRISD = 0;
	clrf	(136)^080h	;volatile
	line	73
	
l3361:	
;Main E_1.c: 73: TRISE = 0;
	clrf	(137)^080h	;volatile
	line	76
	
l3363:	
;Main E_1.c: 76: adc_initialize();
	fcall	_adc_initialize
	line	78
	
l3365:	
;Main E_1.c: 78: beep(2);
	movlw	(02h)
	fcall	_beep
	goto	l3367
	line	83
;Main E_1.c: 83: while(1)
...
l1394:	
	...
	line	91
;Main E_1.c: 89: }
;Main E_1.c: 91: while(1) continue;
...
;; *************** function _beep *****************
;; Defined at:
;;		line 128 in file "E:\Cytron SVN\PTK40A (PIC Training Kit)\Source Code\Examples\Example 1\Main E_1.c"
;; Parameters:    Size  Location     Type
...
l3343:	
;Main E_1.c: 129: while (uc_count-- > 0) {
	goto	l3349
	
l1408:	
	line	130
;Main E_1.c: 130: RC2 = 1;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bsf	(58/8),(58)&7
	line	131
...
l3347:	
;Main E_1.c: 132: RC2 = 0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(58/8),(58)&7
	line	133
;Main E_1.c: 133: delay_ms(100);
	movlw	low(064h)
	movwf	(?_delay_ms)
	movlw	high(064h)
	movwf	((?_delay_ms))+1
...
;; *************** function _delay_ms *****************
;; Defined at:
;;		line 108 in file "E:\Cytron SVN\PTK40A (PIC Training Kit)\Source Code\Examples\Example 1\Main E_1.c"
;; Parameters:    Size  Location     Type
...
l3339:	
;Main E_1.c: 109: while (ui_value-- > 0) {
	goto	l1401
...
l3341:	
;Main E_1.c: 110: _delay((unsigned long)((1)*(20000000/4000.0)));
	opt asmopt_off
movlw	7
...
;; Defined at:
;;		line 27 in file "E:\Cytron SVN\PTK40A (PIC Training Kit)\Source Code\Examples\Example 1\adc.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;;
psect	text103
	file	"E:\Cytron SVN\PTK40A (PIC Training Kit)\Source Code\Examples\Example 1\adc.c"
	line	27
