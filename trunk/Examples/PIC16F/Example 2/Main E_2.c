/*******************************************************************************
* This is the main program for Example 2 using PTK40A PIC Training Board.
*
...
int main(void)
{
	...
	// PTK40A have dedicated 3 push button as digital input, SW1 to SW3.
	// These switches are sharing pin with 4x4 Keypad.
	// This example is to show simple input to control an output.
	// Pressing SW1 will activate BUZZER
	// Pressing SW2 will deactivate BUZZER
