/*******************************************************************************
* This is the main program for Example 1 using PTK40A PIC Training Board.
*
...
int main(void)
{
	...
	// PTK40A have a LED connected to every output pin. 
	// This example is just to blink a LED at RD4
	// LED blinking is basically to ON LED, wait for a while, OFF LED, wait for a while
	// repeat it.
	while(1) 	// create an infinite loop
	{
		RD4 = 1;		// activate LED at RD4
		delay_ms(1000);	// delay for around 1 second
		RD4 = 0;		// deactivate LED at RD4
		delay_ms(1000);	// delay for around 1 second		
	}	
