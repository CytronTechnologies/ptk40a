...
* ~ uc_register_add	- The register address that we want to read.
*
* RETURN:
...
*
*******************************************************************************/
extern unsigned char uc_i2c_read(unsigned char uc_slave_address, unsigned char uc_register_add);
...
*
*******************************************************************************/
extern void uc_i2c_write(unsigned char uc_slave_address, unsigned char uc_register_add, unsigned char uc_data);
