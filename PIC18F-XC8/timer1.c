/*******************************************************************************
* This file provides the functions for the Timer1 module, using 32.768KHz Crystal 
* for PIC18F
*
...
{	
	//T1CONbits.RD16 = 0;	//Timer 1 operate in 8bit mode for read and write
	T1RD16 = 0;	//Timer 1 operate in 8bit mode for read and write
	...
	//T1CONbits.TMR1CS = 1;		// Select external clock.
	TMR1CS = 1;		// Select external clock.
	
	//T1CONbits.T1CKPS1 = 0;		//Prescaler of 1:1
	//T1CONbits.T1CKPS0 = 0;
	T1CKPS1 = 0;		//Prescaler of 1:1
	T1CKPS0 = 0;
	
	//T1CONbits.T1SYNC = 0;		//Donot Sync with system clock
	T1SYNC = 0;		//Donot Sync with system clock
